...
<div id="home">
    <div id="main">
        <div class="text">
            <h6>{leagueName}</h6>
            <p>Welcome to the official website of our Legacy Keeper Fantasy Football League!</p>
		<p>Looking forward to another great season in 2021. Bless all the knees and please keep Covid away from all our studs.</p>
        </div>
        <PowerRankings />
    </div>
